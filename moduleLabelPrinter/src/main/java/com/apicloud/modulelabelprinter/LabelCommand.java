...
public class LabelCommand {
    ...
    public void addPeel(LabelUtils.ENABLE enable) {
    ...
    public void addTear(LabelUtils.ENABLE enable) {
        new String();
        String str = "SET TEAR " + enable.getValue() + "\r\n";
        this.addStrToCommand(str);
    }

    public void addCutter(LabelUtils.ENABLE enable) {
        new String();
    ...
    public void addReprint(LabelUtils.ENABLE enable) {
        new String();
        String str = "SET REPRINT " + enable.getValue() + "\r\n";
        this.addStrToCommand(str);
    }

    public void addPrintKey(LabelUtils.ENABLE enable) {
        new String();
    ...
    public void addPartialCutter(LabelUtils.ENABLE enable) {
        new String();
